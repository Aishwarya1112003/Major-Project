...
if(isset($_POST['submit']))
{
    ...
    $expiry_hours = mysqli_real_escape_string($connection, $_POST['expiry_hours']);
    // $email=$_POST['email'];
    ...
    $query="insert into food_donations(email,food,type,category,phoneno,location,address,name,quantity,expiry_hours) values('$emailid','$foodname','$meal','$category','$phoneno','$district','$address','$name','$quantity', '$expiry_hours')";
    ...
    if(mysqli_num_rows($adminResult) > 0) {
        ...
        try {
            ...
            $mail->Body    = "
                ...
                <br>
                <p>Please log in to accept it.</p>
            ";
...
<body style="    background-color: #06C167;">
    ...
    <p class="logo"><b style="color: #06C167; ">SustainBite</b></p>
       ...
       <div class="input">
        ...
        <div class="input">
        <label for="quantity">Quantity:(no. of serves)</label>
        <input type="text" id="quantity" name="quantity" required/>
    
        <label>Expiry time (in hours):</label>
        <input type="number" name="expiry_hours" required><br><br>
</div>
